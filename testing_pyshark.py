                ...
                if listarp[i] == src_addr or listarp[i] == dst_addr:
                    if re.search(mining, hex_split):
                        ...
                        if len(hex_split) > 1:
                            ...
                            jfile = open("main/neyroset/model.json", "r")
                            loaded_json = jfile.read()
                            jfile.close()
                            loaded_model = model_from_json(loaded_json)

                            loaded_model.load_weights("main/neyroset/weights.hdf5")
                    ...
                    if check_point == 1 and listarp[i] == "192.168.137.100":
                        print('!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!')
                        print(hex_split)
                        pcnum += 1
                        src = 'infected_'
